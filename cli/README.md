...
running command...
$ cli (--version)
cli/0.0.0 win32-x64 node-v18.17.1
$ cli --help [COMMAND]
USAGE
  $ cli COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/arthur-wronski/cli/blob/v0.0.0/dist/commands/hello/index.ts)_
...
_See code: [dist/commands/hello/world.ts](https://github.com/arthur-wronski/cli/blob/v0.0.0/dist/commands/hello/world.ts)_
